...
//One possible arrangement is: {1, 3, 2, 1, 4, 6}. If you return a valid arrangement, output will be 1.
 ...
 Task:
// don't need to read input or print anything. The task is to complete the function threeWayPartition() which takes the array array, a, 
//and b as input parameters and modifies the array in place according to the given conditions.
...
class Solution {
    ...
    threeWayPartition(array, a, b)
    {
        //your code here
         //your code here
        let low = 0;let mid = 0; let high = array.length-1;
        while(mid<=high)
        {
            if(array[mid] < a){
                let temp = array[low];
