//A Toeplitz matrix (also known as a diagonal-constant matrix) is a matrix in which every descending diagonal from left to right
...
Input: mat = [[6, 3, 8],
                ...
                [1, 4, 6]]
Output: false
Explanation:// The primary diagonal elements of the given matrix are [6, 9, 6]. As the diagonal elements are not same, the given matrix
// is not Toeplitz Matrix.
Constraints
