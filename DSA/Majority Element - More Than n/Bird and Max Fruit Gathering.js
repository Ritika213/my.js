//Given an array arr[] representing the fruit values of trees arranged in a circle and an integer m, find the 
//maximum total fruits the bird can collect by visiting at most m trees.
...
Output: 8
Explanation// The bird can start from the second tree and visit the second and third trees, collecting 
//6 + 2 = 8. It can also start from the fourth tree and visit the fourth and fifth trees, collecting 5 + 3 = 8.
