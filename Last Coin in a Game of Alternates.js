...
//At each turn, a player can pick a coin from either the beginning or the end of the array. Both players follow a greedy 
// strategy, i.e., they always pick the coin with the maximum value among the two available ends.
