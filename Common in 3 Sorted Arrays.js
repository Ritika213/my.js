//Given three sorted arrays in non-decreasing order, return all common elements in non-decreasing order across these arrays. If there
//  are no such elements return an empty array.
    ...
    commonElements(a, b, c) {
        ...
        while (i < a.length && j < b.length && k < c.length) {
            ...
            if (x === y && y === z) {
                ...
                let mn = Math.min(x, Math.min(y, z));
                if (x === mn) i++;
                if (y === mn) j++;
                if (z === mn) k++;
            }
