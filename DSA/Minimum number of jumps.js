...
task
//don't need to read input or print anything. Your task is to complete function minJumps() which takes the array arr and it's
// size N as input parameters and returns the minimum number of jumps. If not possible return -1.
