//Given an array arr[], find the smallest number x such that when x is processed sequentially with each element 
// of the array (from index 0 to n-1), it never becomes negative, under the following conditions:
