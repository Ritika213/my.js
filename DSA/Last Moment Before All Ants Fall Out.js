//We have a wooden plank of length n units. Some ants are walking on the plank, each ant moves with a speed of 1 unit per second,
 //with some moving left and others right.
...
//Assume changing directions does not take any additional time. When an ant reaches one end of the plank at a time t, it falls out
 //of the plank immediately.
...
// the time when the last ant(s) fall out of the plank.

Examples// :Input: n = 4, left[] = [2], right[] = [0, 1, 3]
Output: 4
