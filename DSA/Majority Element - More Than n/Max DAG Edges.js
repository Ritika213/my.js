...
//where each entry edges[i] = [u, v] denotes a directed edge from vertex u to vertex v, find the maximum number of additional edges 
//that can be added to the graph without forming any cycles.
