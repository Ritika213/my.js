//Given an array arr[] of integers, sort the array (in descending order) according to count of set bits in binary representation 
// of array elements. 
...
class Solution {
    ...
    sortBySetBitCount(arr) {
        // stable sort (modern JS engines like V8 support it)
        return arr.sort((a, b) => {
            return this.countBits(b) - this.countBits(a); // descending
        });
    }
}