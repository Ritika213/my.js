...
Output: 6
Explanation:// Subarrays with sum = 15 are [5, 2, 7, 1], [10, 5] and [10, 5, 2, 7, 1, -10]. The length of the longest subarray with 
//a sum of 15 is 6.
...
class Solution {
    longestSubarray(arr, k) {
        ...
        let ans = 0;
        let map = new Map();
        map.set(0, -1); // Initialize prefix sum map with base case
        let sum = 0;
