//given a perimeter & the area. Your task is to return the maximum volume that can be made in the form of a cuboid from the given perimeter and
// surface area.
...
class Solution {
    ...
    */
    maxVolume(perimeter, area) {
        ...
        let length = (perimeter - Math.sqrt((perimeter*perimeter) - 24*area))/12;
        let height = perimeter/4-2*length;
