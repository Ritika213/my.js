...
//contains a loop or not and if the loop is present then return the count of nodes in a loop or else return 0. C is the position of the 
//node to which the last node is connected. If it is 0 then no loop.
...
Explanation: //The length of the loop is 2.
 Task:
//The task is to complete the function countNodesinLoop() which contains the only argument as reference to head of linked list and return 
//the length of the loop ( 0 if there is no loop).
