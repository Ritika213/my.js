//given an array arr[] of positive integers, where each element arr[i] represents the number written on the i-th ball, 
// and a positive integer k.
//task is to determine whether it is possible to rearrange all the balls into groups such that:
