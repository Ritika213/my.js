// given a string str containing two fractions a/b and c/d, compare them and return the greater. If they are equal, then return "equal".
...
class Solution {
    ...
    */
    compareFrac(str) {
        ...
        'equal' : ((eval(arr[0]) > eval(arr[1])) ? arr[0] : arr[1]);
    }
}
