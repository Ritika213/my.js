...
//6 1 indicated that 6 should be inserted in the end. Modified LinkList = 9,5,6.
//2 0 indicated that 2 should be inserted in the beginning. ModifiedLink List = 2,9,5,6.
//5 0 indicated that 5 should be inserted in the beginning. ModifiedLink List = 5,2,9,5,6. 
...
Output:// 5 6 9
 ...
 Task:
//You only need to complete the functions insertAtBeginning() and insertAtEnd() that takes the head of link list and integer value of the data
// to be inserted as inputs and returns the head of the modified link list. 
