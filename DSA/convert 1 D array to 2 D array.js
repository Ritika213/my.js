// given a 0-indexed 1-dimensional (1D) integer array original, and two integers, m and n. You are tasked with creating a 2-dimensional (2D) 
...
var construct2DArray = function(original, m, n) {
   ...
   for (let i = 0; i < m; i++) {
     res.push(original.slice(start, start + n));
     start += n;
   }
